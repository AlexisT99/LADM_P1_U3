...
import mx.tecnm.tepic.ladm_p1_u3.databinding.FragmentListaConductoresVencidasBinding
import java.io.File
 ...
 * Use the [ListaConductoresVencidas.newInstance] factory method to
 * create an instance of this fragment.
 */
class ListaConductoresVencidas : Fragment(),RecyclerAdapterConductores.onClickListener, SearchView.OnQueryTextListener {
    ...
    private lateinit var _binding: FragmentListaConductoresVencidasBinding
    ...
    override fun onCreateView(
        ...
        _binding = FragmentListaConductoresVencidasBinding.inflate(inflater, container, false)
        return b.root
    }
        ...
        b.btnexc.setOnClickListener{
            if(tieneSd()){
                try {
                    ...
                    val file = File(primaryExternalStorage, "Conductores con licencia vencida "+formattedDate+".csv")
    ...
    private fun setupRecyclerView(){
        ...
        listaConductores = c.consultaVencidas()
        listaConductoresOriginal = c.consultaVencidas()
    ...
    override fun onItemLongClick(id: Int, nombre: String, itemView: View, position: Int): Boolean{
        ...
        menu.setOnMenuItemClickListener {
            ...
            if (it.title.equals("Borrar")) {
                ...
                builder.setMessage("¿Estas Seguro de borrar el conductor ${nombre}?")
